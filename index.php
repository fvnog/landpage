                  ...
                  <div class="col-lg-7">
                      <div class="hero-content">
                          ...
                          <h2 class="wow fadeInUp pb-5" data-wow-delay=".5s">Gestão de Rede Social,</br>
                              ...
                              <style>
/* Estilo para telas maiores (não celular) */

/* Estilo para telas menores (modo celular) */
@media (max-width: 768px) {
    h2 {
        font-size: 16px; /* Tamanho de fonte para h2 em telas menores (modo celular) */
    }
}
</style>
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-md-4">
                  <div class="service-item service-style-two mb-40 wow fadeInUp" data-wow-delay=".15s">
                      <div class="icon">
                        <img src="img/icon/content-strategy.png" class="icon-service">
                    </div>
                      <div class="text">
                          <h3 class="title"><a href="service-details.html">Marketing Digital</a></h3>
                          <ul class="list-style-two">
                              <li>Impulsionamento</li>
                              <li>Orgânico</li>
                              <li>Conversão</li>
                          </ul>
                          <a href="pages/marketing.php" class="btn-link">Saiba Mais sobre Marketing Digital</a>
                        </div>
                  </div>
              </div>
              ...
              <div class="col-md-4">
                  <div class="service-item service-style-two mb-40 wow fadeInUp" data-wow-delay=".15s">
                      ...
                      <div class="text">
                          ...
                          <a href="pages/gestao.php" class="btn-link">Saiba Mais sobre Gerênciamento</a>
                        </div>
                  </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="service-item service-style-two mb-40 wow fadeInUp" data-wow-delay=".15s">
                    ...
                    <div class="text">
                        ...
                        <a href="pages/website.php" class="btn-link">Saiba Mais sobre WebSite</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="service-item service-style-two mb-40 wow fadeInUp" data-wow-delay=".15s">
                  ...
                  <div class="text">
                      ...
                      <a href="pages/designgrafico.php" class="btn-link">Saiba Mais sobre Design Gráfico</a>
                    </div>
              </div>
          </div>
                  ...
                  <div class="service-item service-style-two mb-40 wow fadeInUp" data-wow-delay=".15s">
                      ...
                      <div class="text">
                          ...
                          <a href="pages/automacao.php" class="btn-link">Saiba Mais sobre Automação</a>
                        </div>
                  </div>
              </div>
              ...
              <div class="row portfolio-grid">
                  <div class="col-lg-4 col-md-6 col-sm-12 cat-1 portfolio-column cat-1">
                      <div class="portfolio-item portfolio-style-two mb-50 wow fadeInUp" data-wow-delay=".1s">
                          <div class="img-holder">
                              <img src="img/sites/BI FASHION.png" alt="Img">
                              <div class="portfolio-hover">
                                  <div class="hover-content">
                                      <a href="pages/website.php" class="cat-btn">WebSite</a>
                                      <h4><a href="https://bifashion.com.br/">BiFashion</a></h4>
                                  </div>
                              </div>
                          </div>
                      </div>
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-12 portfolio-column cat-1">
                      <div class="portfolio-item portfolio-style-two mb-50 wow fadeInUp" data-wow-delay=".2s">
                          <div class="img-holder">
                              <img src="img/sites/ACR.png" alt="Img">
                              <div class="portfolio-hover">
                                  <div class="hover-content">
                                      <a href="pages/website.php" class="cat-btn">WebSite</a>
                                      <h4><a href="https://acabamentosribeiro.com.br/">Acabamentos Ribeiro</a></h4>
                                  </div>
                              </div>
                          </div>
                      </div>
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-12 portfolio-column cat-3 cat-2">
                      <div class="portfolio-item portfolio-style-two mb-50 wow fadeInUp" data-wow-delay=".3s">
                          <div class="img-holder">
                              <img src="img/Logos/Resultar.png" alt="Img">
                              <div class="portfolio-hover">
                                  <div class="hover-content">
                                      <a href="#" class="cat-btn">Design Gráfico</a>
                                      <h4><a href="pages/designgrafico.php">Resultar Mind Logo</a></h4>
                                  </div>
                              </div>
                          </div>
                      </div>
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-12 portfolio-column cat-4 cat-2">
                      <div class="portfolio-item portfolio-style-two mb-50 wow fadeInUp" data-wow-delay=".4s">
                          <div class="img-holder">
                              <img src="img/Flyer/1.png" alt="Img">
                              <div class="portfolio-hover">
                                  <div class="hover-content">
                                      <a href="#" class="cat-btn">Design Gráfico</a>
                                      <h4><a href="pages/designgrafico.php">Flyer Promocional</a></h4>
                                  </div>
                              </div>
                          </div>
                      </div>
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-12 portfolio-column cat-5 cat-1">
                      <div class="portfolio-item portfolio-style-two mb-50 wow fadeInUp" data-wow-delay=".5s">
                          <div class="img-holder">
                              <img src="img/sites/MICROLINS.png" alt="Img">
                              <div class="portfolio-hover">
                                  <div class="hover-content">
                                      <a href="pages/website.php" class="cat-btn">WebSite</a>
                                      <h4><a href="https://microlinsgv.com.br/">Microlins GV</a></h4>
                                  </div>
                              </div>
                          </div>
                      </div>
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-12 portfolio-column cat-4 cat-2">
                      <div class="portfolio-item portfolio-style-two mb-50 wow fadeInUp" data-wow-delay=".6s">
                          <div class="img-holder">
                              <img src="img/Flyer/3.png" alt="Img">
                              <div class="portfolio-hover">
                                  <div class="hover-content">
                                      <a href="#" class="cat-btn">Design Gráfico</a>
                                      <h4><a href="pages/designgrafico.php">Flyer Promocional</a></h4>
                          ...
                          <div class="text-wrapper mb-40 wow fadeInLeft">
                              ...
                              <div class="information-style-two d-flex mb-20">
                                  ...
                                  <div class="info">
                                      ...
                                      <h4><a href="mailto:contatos@resultarmind.com.br">contatos@resultarmind.com.br</a></h4>
                                  </div>
                              </div>
                              ...
                              <div class="information-style-two d-flex mb-20">
                                  ...
                                  <div class="info">
                                      ...
                                      <h4><a href="tel:+553399486265">+55 33 9948-6265</a></h4>
                                  </div>
                              </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form_group">
                <input type="text" class="form_control" placeholder="Nome completo" id="name" name="name" required>
            </div>
        </div>
        <div class="col-lg-12">
            <div class="form_group">
                <input type="email" class="form_control" placeholder="E-mail" id="email" name="email" required>
            </div>
        </div>
        <div class="col-lg-12">
            <div class="form_group">
                <select class="wide" id="assunt" name="assunto">
                    <option selected value="">Assunto</option>
                    <option value="Gerênciamento de Redes Sociais">Gerênciamento de Redes Sociais</option>
                    <option value="Criação de WebSite">Criação de WebSite</option>
                    <option value="Design Gráfico">Design Gráfico</option>
                    <option value="Automação com BOT">Automação com BOT</option>
        ...
        <div class="col-lg-12">
            <div class="form_group">
                <input type="text" class="form_control" placeholder="Número de telefone" id="phone" name="phone" required>
            </div>
        </div>
        <div class="col-lg-12">
            <div class="form_group">
                <button type="submit" class="main-btn arrow-btn">Enviar Mensagem</button>
            </div>
        </div>
    </div>
</form>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        form.addEventListener("submit", function (event) {
            ...
            const assunto = document.getElementById("assunt").value;
...
👤 *Nome:* ${nome}
📧 *E-mail:* ${email}
🛍️ *Produto Selecionado:* ${assunto}
📞 *Telefone:* ${telefone}`;

            // Número de telefone do vendedor (substitua pelo número correto)
            const numeroVendedor = "+553399486265";
      ...
      <section class="intro-area intro-area-v1 pb-5">
          <div class="container">
              <div class="row">
                  <div class="col-lg-12">
                      <div class="play-content bg_cover text-center wow fadeInUp" style="background-image: url(img/capa.png);">
                          <a href="https://youtu.be/CXKDZe4UniY" class="video-popup"><i class="fas fa-play"></i></a>
                      </div>
                  </div>
              </div>
          </div>
                  ...
                  <div class="row align-items-center">
                      ...
                      <div class="col-lg-5">
                          <div class="button-box float-lg-right">
                              <a href="#contact" class="main-btn bordered-btn btn-white arrow-btn page-scroll nav-link">Fale com nossa equipe</a>
                          </div>
                      </div>
                  </div>
              </div>
